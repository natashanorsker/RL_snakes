...
class ChessTournament(Env):
    ...
    def step(self, action):
        game_outcome = None # should be [-1, 0, 1] depending on outcome of single game.
        ...
        # TODO: 1 lines missing.
        raise NotImplementedError("Compute reward here.")
...
def main():
    ...
    # TODO: 1 lines missing.
    raise NotImplementedError("Compute stats here using train.")
