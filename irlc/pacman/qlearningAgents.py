...
from irlc.berkley.pacman.gym_game import *
from irlc.berkley.pacman import util
from irlc.berkley.pacman.learningAgents import ReinforcementAgent
from irlc.berkley.pacman.featureExtractors import *
...
class PacmanQAgent(QLearningAgent):
    ...
    def __init__(self, epsilon=0.05, gamma=0.8, alpha=0.2, numTraining=0, **args):
        ...
        For old, to change the exploration rate, try:
